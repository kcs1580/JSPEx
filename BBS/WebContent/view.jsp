		...
		<div class="row">
			...
			<table class="table table-stripped"
				...
				<thead>
					<tr>
						<th colspan="3"
							style="backgorund-color: #eeeeee; text-align: center;">게시판 글
							보기</th>
					</tr>
				</thead>
				<tbody>
			...
			<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?bbsID=<%=bbsID%>" class="btn btn-warning">삭제</a>
			<%
				}
			%>
